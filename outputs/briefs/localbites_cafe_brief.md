# Diagnostic Brief — LocalBites Cafe

*Generated 2026-05-13 — Zeutara Inflection Detector — extraction mode: `rule_based`*

- **Inflection score:** 0 / 100
- **Confidence:** 30 / 100
- **Disqualifier penalty applied:** -80
- **Route:** `disqualified`
- **Primary structural constraint:** `operational_complexity_growth`
- **Source confidence:** low
- **Company URL:** https://example-localbites.com

## Why this company, now

LocalBites Cafe shows operational complexity rising faster than the operating cadence in place to absorb it. Specific signal set is in the reason codes below.

### Evidence

- **no_b2b_revenue_motion** (low): "B2B language present but explicitly negated in source."
  - Source: sample_inputs/sample_company_page.html
- **local_smb_only** (medium): "from analyst notes. Run with --live for real HTTP fetches.) Family-owned local cafe serving the Brooklyn neighborhood area. Brick-an"
  - Source: sample_inputs/sample_company_page.html

### Reason codes (audit trail)

- `disqualifier_SEVERE: no_b2b_revenue_motion (-45)`
- `disqualifier_SEVERE: local_smb_only (-35)`
